...
public class MenuButtonFactory {
	...
	// number of menuItem that is increased after each makeMenuButton. Used to position the button correctly
	 ...
	 * @param context  a Game context where 
	 * @param label string button's label
	 * @param nextScreenAfterClick the next screen that will be showed after button click
	 * @return a new TextButton ready to be added to a stage
	 */
	public TextButton makeMenuButton(final Game context, String label, final Screen nextScreenAfterClick) {
        ...
        button.addListener(new ChangeListener() {
			...
			public void changed(ChangeEvent event, Actor actor) {
				...
				context.getScreen().dispose();
				context.setScreen(nextScreenAfterClick);
			}
		});
        return button;
	}
	 ...
	 * @param initPosXMenu value of corner's coordinate x
	 */
	 ...
	 * @param initPosYMenu value of corner's coordinate x
	 */
	 ...
	 * @param menuItemHeight height value
	 */
	 ...
	 * @param menuItemWidth width value
	 */
